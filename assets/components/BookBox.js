            ...
            <div className='bookData'>
                ...
                <div>
                    <ul>
                        ...
                        <li><b>Résumé</b><p onTransitionEnd={handleTransitionEnd} className={moreInfos ? 'active' : ''}> {showMore ? book.resume : book.resume.substring(0, 110)} {(book.resume.length > 110 && !showMore) ? '...' : ''}</p></li>
                    </ul>
